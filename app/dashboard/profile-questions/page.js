...
export default function Dashboard() {
  ...
  const ProfileForm = () => (
    <div className="bg-black bg-opacity-40 backdrop-blur-lg text-white w-[800px] p-8 rounded-lg shadow-lg z-10 relative ml-32">
      ...
      {/* Form Steps (step 1 - 5 as previously defined) */}
            {step === 1 && (
        <div>
          {/* Phase 1 Questions */}
 ...
 // Toast Component
const Toast = () => (
  <div className="fixed top-4 left-1/2 transform -translate-x-1/2 bg-white text-black px-4 py-3 rounded-lg shadow-lg flex items-center gap-2 z-50">
    <FontAwesomeIcon icon={faCheckCircle} className="text-black text-xl" />
    <span className="font-semibold">Heyy Young Ceo! Profile Completed...</span>
  </div>
);
